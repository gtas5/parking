...
public class MapFragmentDemo extends Fragment {
...
*/		
		...
		positionButton = (Button) rootview.findViewById(R.id.button_position);
		...
		positionButton.setOnClickListener(btnClickListener);
